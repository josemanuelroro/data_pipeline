#========================================================================
#This script tracks the request.flag file and when is detected it generetates
#an image of connection by countris,cities and providers
#------------------------------------------------------------------------
#
#
#
...
def image():
    #Read the parquet file with pandas generated by carga_logs.py  
...
#This tracks the file and detect when it is created
while True:
